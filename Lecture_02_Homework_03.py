...
check = bool(number < 0) or print ('You`ve entered a not negative number!!!\n')

# 2. Write a Python program to check if the value a is less than 20 or not.
a = float(input('Please, enter variable a: '))
...
number = float(input('Please, enter number: '))
check = bool(number != 0) or print ('You`ve entered a number Zero\n')
check = bool(number == 0) or print ('You`ve entered not Zero\n')
