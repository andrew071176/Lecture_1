...
rect_width = float(input('Please, input rectangle width: '))
rect_lenth = float(input('Please, input rectangle lenth: '))
print ('The area of rectangle is: ', rect_width*rect_lenth, '\n')
...
print ('The product of two numbers is: ', number_1 * number_2)
...
circle_radius = float(input ('Please, input radius of circle: '))
print ('The circles`s diameter is: ', circle_radius*2)
print ('The circumference is: ', 2*3.14159*circle_radius)
print ('The circle`s area is: ', 3.14159*circle_radius**2)
